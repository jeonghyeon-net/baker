...
func TestClientListMyPullRequestsForRepositoryFiltersCrossRepositoryAndSortsByUpdatedAt(t *testing.T) {
	runner := &fakeRunner{lookup: map[string]internalexec.Result{
		"gh\x00pr\x00list\x00--repo\x00creatrip/admin\x00--author\x00@me\x00--state\x00open\x00--json\x00number,title,headRefName,updatedAt,isDraft,reviewDecision,isCrossRepository": {
			Stdout: `[
				{"number":11,"title":"older pr","headRefName":"feature/older","updatedAt":"2024-01-01T00:00:00Z","isDraft":false,"reviewDecision":"APPROVED","isCrossRepository":false},
				{"number":12,"title":"fork pr","headRefName":"feature/fork","updatedAt":"2025-04-01T00:00:00Z","isDraft":false,"reviewDecision":"REVIEW_REQUIRED","isCrossRepository":true},
				{"number":13,"title":"new pr","headRefName":"feature/new","updatedAt":"2025-05-01T00:00:00Z","isDraft":true,"reviewDecision":"","isCrossRepository":false}
			]`,
		},
	}}
	client := Client{Runner: runner}
	...
	expected := []domain.GitHubPullRequest{
		...
		{Number: 11, Title: "older pr", HeadRefName: "feature/older", UpdatedAt: "2024-01-01T00:00:00Z", IsDraft: false, ReviewDecision: "APPROVED"},
	}
